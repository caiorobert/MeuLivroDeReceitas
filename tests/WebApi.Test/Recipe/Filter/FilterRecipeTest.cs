...
public class FilterRecipeTest : MyRecipeBookClassFixture
{
    ...
    public async Task Success()
    {
        ...
        responseData.RootElement.GetProperty("recipes").EnumerateArray().ToList().ShouldSatisfyAllConditions(
            a => a.ShouldNotBeEmpty(),
            a => a.ShouldNotBeNull()
            );
    }
    ...
    public async Task Error_CookingTime_Invalid(string culture)
    {
        ...
        errors.ShouldSatisfyAllConditions(
            ...
            e => e.ShouldContain(c => c.GetString()!.Equals(expectedMessage)));
    }
}