...
public class UpdateRecipeUseCaseTest
{
    ...
    public async Task Error_Recipe_NotFound()
    {
        ...
        exception.Message.ShouldBe(ResourceMessagesExceptions.RECIPE_NOT_FOUND);
    }
    ...
    public async Task Error_Title_Empty()
    {
        ...
        exception.ShouldSatisfyAllConditions(
            e => e.GetErrorMessages().Count.ShouldBe(1),
            e => e.GetErrorMessages().ShouldContain(ResourceMessagesExceptions.RECIPE_TITLE_EMPTY)
        );
    }
